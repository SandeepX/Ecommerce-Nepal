...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.dashboard',compact('pending','processing','completed','products','users','blogs','days','sales','pproducts','rorders','poproducts','rusers','referrals','browsers'));
    }
    ...
    public function movescript(){
        ...
        $files = public_path();
        $bkupname = 'cn-multivendor-'.date('Y-m-d').'.zip';
