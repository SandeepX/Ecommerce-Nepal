...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	<meta name="Author" content="TheProductNepal">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title> TheProductNepal - Script Installer</title>
	<!-- favicon -->
...
<?php
	...
	define('CNMULTIVENDOR','https://cninfotech.com/verify/');
				...
				<div class="installer-wrapper">
					<div class="installer-box">
						<div class="heading-area">
							<h4 class="title">
									<i class="fas fa-cogs"></i> Multi-Vender Installer
							</h4>
						</div>
						<div class="content">
